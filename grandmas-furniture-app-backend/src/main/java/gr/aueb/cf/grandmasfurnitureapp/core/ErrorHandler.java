...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ResponseMessageDTO> handleDataIntegrityViolationException(DataIntegrityViolationException e) {
        return new ResponseEntity<>(
            new ResponseMessageDTO("dataIntegrityViolation", e.getMessage()), 
