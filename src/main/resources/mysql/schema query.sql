...
('admin1', '$2a$12$rm5kwM8zae6qvnTCQeG0JnsgwNSLAZ3WgjwKrux3RLSQhCSqzb5u', 'Maria', 'Papadopoulos', 'admin1@grandmasfurniture.com', '6932123456', 'ADMIN'),
('admin2', '$2a$12$7qX3/3QTax3O3M1tKNH3bJuOj.4pQy5mm2AE1fQJkmnyfLlFrJnQs', 'Yannis', 'Kostas', 'admin2@grandmasfurniture.com', '6945987654', 'ADMIN'),
('user1', '$2a$12$axGwL3pHpDX42bOFwd2e.X3572D0onQGnmlUJX7172hQx59RG', 'Elena', 'Dimitriou', 'elena.dimitriou@email.com', '6976543210', 'USER'),
('user2', '$2a$12$bBRLNJ3vPuKiNJ9dCJOZOePfWWQaA1.foaBea9s71dx0yPT1A4', 'Nikos', 'Stavros', 'nikos.stavros@email.com', '6987654321', 'USER'),
('user3', '$2a$12$WyZhPOEeaJh9441dHILnK5u2vjddbokKCZH.pQl6QHYEfO', 'Anna', 'Georgiou', 'anna.georgiou@email.com', '6998765432', 'USER'),
('user4', '$2a$12$IqWNnZtYnDoeAFqyQ3rDK.59hCDY2NQNSVFlBWEm1XW3BCZEKQr2', 'Petros', 'Michalis', 'petros.michalis@email.com', '6944321098', 'USER'),
('user5', '$2a$12$9ohLJ3nHFVmAkPR6AL.A315I5t5KqTkIEVlDT1nYZJAGsarW', 'Sofia', 'Vasiliki', 'sofia.vasiliki@email.com', '6955432109', 'USER'),
('user6', '$2a$12$WQLSv9rW7LSWlArBnVtdOeAqaRsYauEF7MXZnXPaPApdtWtX3KK', 'Dimitris', 'Andreas', 'dimitris.andreas@email.com', '6966543210', 'USER'),
('user7', '$2a$12$VQ.zmkSkdKnYnDehNnGrOQOSyKxR.mTS1kgvn1qpNPGgJnMuzJO', 'Ioanna', 'Christina', 'ioanna.christina@email.com', '6977654321', 'USER'),
('user8', '$2a$12$m5VKQHghmvmlMsys85o.qGT3OULL2MU.saxDAINL.yKzTe6bnC', 'Kostas', 'Spyros', 'kostas.spyros@email.com', '6988765432', 'USER'),
('user9', '$2a$12$9P4Q8JTDDIEBsOCsy0GC.cpKPO94EBpoGXC.vxwyFHZG203ZWi', 'Katerina', 'Eleni', 'katerina.eleni@email.com', '6999876543', 'USER'),
('user10', '$2a$12$KLazUhBF6nNbJtlnk2i.qeQCFRO.1uZejttHbJU07CGCNmYCGRGJm', 'Alexandros', 'Thanasis', 'alexandros.thanasis@email.com', '6932098765', 'USER'),
('user11', '$2a$12$PvnQHCNgLHEO2NjweKWaLa.TGgTZMMzYnUSsqxFuA3WmdJmQQy', 'Despina', 'Fotini', 'despina.fotini@email.com', '6943109876', 'USER'),
('user12', '$2a$12$1aTi1vDoJS.xMemBAf3Kf.JuEPneR4AAS9KGYGJbkyAn2KZRmy', 'Giorgos', 'Manolis', 'giorgos.manolis@email.com', '6954210987', 'USER'),
('user13', '$2a$12$T8JhBzKgtJENrEGSkM.iTVoau1DIThSsr5r6m2VMJwom.TJqvaJW', 'Vasiliki', 'Panagiota', 'vasiliki.panagiota@email.com', '6965321098', 'USER'),
('user14', '$2a$12$f2BJrMpHjVc3yjOjScAhSl.BetBl4qawytNXnSB359JddnqpMklS', 'Christos', 'Apostolos', 'christos.apostolos@email.com', '6976432109', 'USER'),
('user15', '$2a$12$qzOK2MQLCHbMNbw8P1JbJZVUQpP0UmfvSRdCJz2RuPhtbBrOry', 'Athina', 'Irini', 'athina.irini@email.com', '6987543210', 'USER'),
('user16', '$2a$12$mToYTFyj6RoAA1UPMicaSazf2mek8CkWuE7UgSu3.KzmiN4W', 'Stavros', 'Panagiotis', 'stavros.panagiotis@email.com', '6998654321', 'USER'),
('user17', '$2a$12$FEQJE7DLg7q.wVnYYfCkuoXTGQdrqH2QYECLnvgMJp6h1SABy', 'Margarita', 'Sophia', 'margarita.sophia@email.com', '6932765432', 'USER'),
('user18', '$2a$12$9YjWAU4oLZO9erGSO4o.QHYJXbsfBBanwMRd6mbHPd43PdFSa2', 'Vasilis', 'Ioannis', 'vasilis.ioannis@email.com', '6943876543', 'USER');
